...
from pynt.lstm_utils import LstmUtils as utils
# from pynt import plotting
...
class LstmModel():
    def __init__(self, df: pd.DataFrame, ticker: str):
        ...
        for field in nmd_array_fields:
            nmd_array_dict[field] = utils.series_to_ndarray(self.df, self.window_length, column=field)

        # attributes model needs:
        # - params
        # - window length
        # - ticker
        # - batch size
    ...
    # def randomised_model_config(self, test_windows,df_p,test_days,
